...
#Specify the number of plot rows and columns.
par(mfrow = c(2,2), mar = c(5,4,1,1), oma=c(0.5,0.5,1,0.5))

#Plot the first plot.
with(dataset, plot(Date_Time, Global_active_power, type="l", ylab="Global Active Power",
                   xlab="Day of the Week"))

#Plot the second plot.
with(dataset, plot(Date_Time, Voltage, type="l", ylab="Voltage",
                   xlab="Day of the Week"))
...
#Now plot the fourth plot.
with(dataset, plot(Date_Time, Global_reactive_power, type="l", ylab="Global Reactive Power",
                   xlab="Day of the Week"))
